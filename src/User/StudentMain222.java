 ...
 */
public class StudentMain222 extends javax.swing.JFrame {

    /**
     * Creates new form StudentMain
     */
    public StudentMain222() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentMain222.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentMain222().setVisible(true);
            }
        });
    }
